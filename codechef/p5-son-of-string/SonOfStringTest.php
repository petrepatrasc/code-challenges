...
class SonOfStringTest extends PHPUnit_Framework_TestCase {
    ...
    public function testGetSonForString() {
        ...
        $this->son->setProblemString('0');
        $actualSon = $this->son->getSonForString();
        $this->assertEquals('0', $actualSon);

        $this->son->setProblemString('');
        $actualSon = $this->son->getSonForString();
        $this->assertEquals('', $actualSon);

        $this->son->setProblemString('0134');
        $actualSon = $this->son->getSonForString();
        $this->assertEquals('30', $actualSon);

        $this->son->setProblemString('735903');
        $actualSon = $this->son->getSonForString();
        $this->assertEquals('157', $actualSon);

        $this->son->setProblemString('000000');
        $actualSon = $this->son->getSonForString();
        $this->assertEquals('00', $actualSon);

        $this->son->setProblemString('123456789');
        $actualSon = $this->son->getSonForString();
        $this->assertEquals('0121', $actualSon);
